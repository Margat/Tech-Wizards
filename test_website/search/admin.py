...
class CarAdmin(admin.ModelAdmin):
    list_display = ('car_make', 'car_model', 'car_series', 'car_series_year', 'car_price_new', 'car_engine_size', 'car_fuel_system', 'car_tank_capacity',
...
class CustomerAdmin(admin.ModelAdmin):
    list_display =('customer_name', 'customer_address', 'customer_birthday', 'customer_occupation', 'customer_gender')

class StoreAdmin(admin.ModelAdmin):
    list_display = ('store_name', 'store_address', 'store_phone', 'store_city', 'store_state')

class OrderAdmin(admin.ModelAdmin):
    list_display = ('order_create_date', 'order_pickup_date', 'order_pickup_store', 'pickup_store_name', 'pickup_store_address', 'pickup_store_phone', 'pickup_store_city',
